...
export class MoviesService {
  private movies: Movie[] = [
    ...
    { title: 'Transaction History', description: 'A list of transactions will appear here. We can reuse the "transaction history" design here', isPinned: false, expanded: true},
    { title: 'Receipts', description: 'A list of receipts will appear here. We can reuse the "receipts" design here', isPinned: false, expanded: true},
    { title: 'Receipts', description: 'A list of receipts will appear here. We can reuse the "receipts" design here', isPinned: false, expanded: true},
    { title: 'Receipts', description: 'A list of receipts will appear here. We can reuse the "receipts" design here', isPinned: false, expanded: true},   
    { title: 'Receipts', description: 'A list of receipts will appear here. We can reuse the "receipts" design here', isPinned: false, expanded: true},
    { title: 'Receipts', description: 'A list of receipts will appear here. We can reuse the "receipts" design here', isPinned: false, expanded: true}
